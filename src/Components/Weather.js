...
const Weather = ({ mode, displayActivities, location, setLocation }) => {
      //initial user location. Do it with another react hook? 
    ...
    // })
    return (
        <div className={(displayActivities) ? ("weather-box-animated") : ("weather-box")}>
